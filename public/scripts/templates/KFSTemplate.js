...
export default class KFSTemplate extends Template {
    constructor() {
        super("KFS");
                                ...
                                <tr>
                                    <td>
                                        <table bgcolor="#ffffff" class="full-width" border="0" cellpadding="0" cellspacing="0" role="presentation" width="640" style="width:640px;">
                                            <tr>
                                                <td bgcolor="#ffffff" align="left" class="px-2" style="padding-left:40px;padding-right:40px;padding-top:40px;padding-bottom:0px;font-family: Titillium Web, Arial, sans-serif;font-size:16px;line-height:normal;background-color: #ffffff; color:#131b29">
                                                    <p style="margin:0;margin-top:0px;font-size:18px;font-weight:900;">
                                                        Nabór wniosków na dofinansowanie kursów z Krajowego Funduszu Szkoleniowego w powiecie <a style="text-decoration:none;color:#131b29;">xxxxxxxx</a> odbędzie się w terminie <a style="text-decoration:none;color:#131b29;">od&nbsp;16.11&#8209;17.11.2023&nbsp;r.</a>
                                                    </p>
                                                    <p style="margin:0;margin-top:10px;">
                                                        Dofinansowanie z KFS do 100% dla pracowników oraz pracodawców gdzie liczba osób zatrudnionych nie przekracza 9&nbsp;osób.
                                                    </p>
                                                    <p style="margin:0;margin-top:10px;">
                                                        Dofinansowanie z KFS do 80% dla pracowników oraz pracodawców gdzie liczba osób zatrudnionych przekracza 9&nbsp;osób.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
