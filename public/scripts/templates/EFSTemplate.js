...
export default class EFSTemplate extends Template {
    constructor() {
        super("EFS");
        this.modifiers = [
            {
                            ...
                            <table class="full-width" width="640" bgcolor="#E4E4E4" style="width: 640px; margin: auto" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                    <td>
                                        <table class="full-width" border="0" cellpadding="0" cellspacing="0" role="presentation" width="640" style="width: 640px">
                                            ...
                                            <tr>
                                                <td bgcolor="#ffffff" class="px-2" style="padding-left: 40px; padding-right: 40px; padding-top: 10px; padding-bottom: 10px; font-family: Titillium Web, Arial, sans-serif; font-size: 16px; line-height: normal; background-color: #ffffff; color: #131b29">Panie XXXXXX, w nawiązaniu do rozmowy przesyłam linki do szkoleń oraz&nbsp;kalkulacje.</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <table class="full-width" border="0" cellpadding="0" cellspacing="0" role="presentation" width="640" style="width: 640px">
                                            <tr>
                                                <td bgcolor="#ffffff" class="px-2" style="padding-left: 40px; padding-right: 40px; padding-top: 10px; padding-bottom: 0px; font-family: Titillium Web, Arial, sans-serif; font-size: 16px; line-height: normal; background-color: #ffffff; color: #131b29;font-weight:600;">Dofinansowanie z Funduszy Europejskich to XX%</td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#ffffff" class="px-2" style="padding-left: 40px; padding-right: 40px; padding-top: 0px; padding-bottom: 10px; font-family: Titillium Web, Arial, sans-serif; font-size: 16px; line-height: normal; background-color: #ffffff; color: #131b29;font-weight:600;">Kwota dofinansowana to XXXXzł + dopłata z Pana strony XXXXzł = 1 Etap.</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-bottom:40px;background-color:#ffffff;">
                                        <table class="full-width" border="0" cellpadding="0" cellspacing="0" role="presentation" width="640" style="width: 640px">
                                            <!--%%[CONTENT]%%-->
                                        </table>
                                    </td>
